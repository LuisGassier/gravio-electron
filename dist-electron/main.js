import Jt, { app as Ut, BrowserWindow as Hu, ipcMain as He, shell as Nv } from "electron";
import jt from "fs";
...
function yt() {
  if (xl) return zn;
  xl = 1;
  var e = jt, t = Lv(), s = qv(), n = Fv(), l = zu, r, i;
...
function jv() {
  if (Bl) return Kn;
  Bl = 1;
  const e = /* @__PURE__ */ Jr(), { checkPath: t } = /* @__PURE__ */ Uv(), s = (n) => {
    const l = { mode: 511 };
...
function Mt() {
  if (Hl) return Is;
  Hl = 1;
  const e = wt().fromPromise, { makeDir: t, makeDirSync: s } = /* @__PURE__ */ jv(), n = e(t);
  return Is = {
    mkdirs: n,
    mkdirsSync: s,
    // alias
...
function l_() {
  ...
  const e = kn, t = u_(), s = jt, n = Dn, l = Yr, r = Yu(), i = ts(), u = Cg(), o = (0, t.default)("electron-builder");
  function c(_, w = null) {
...
` ? (O.line++, O.column = 0) : O.column++);
            ...
            case P.CLOSE_TAG:
              if (O.tagName)
                H === ">" ? j(O) : w(y, H) ? O.tagName += H : O.script ? (O.script += "</" + O.tagName, O.tagName = "", O.state = P.SCRIPT) : (b(H) || B(O, "Invalid tagname in closing tag"), O.state = P.CLOSE_TAG_SAW_WHITE);
              else {
                if (b(H))
                  continue;
            ...
            case P.CLOSE_TAG_SAW_WHITE:
              if (b(H))
                continue;
              H === ">" ? j(O) : B(O, "Invalid characters in closing tag");
              continue;
            case P.TEXT_ENTITY:
...
`, te - 1));
  ...
  function H(S, te) {
    var ie = !0, pe, ae, de, le = S.tag, me, ve = S.anchor, qe, Fe, $e, U, ne, se = /* @__PURE__ */ Object.create(null), oe, ce, ye, he;
    ...
    for (S.anchor !== null && (S.anchorMap[S.anchor] = me), he = S.input.charCodeAt(++S.position); he !== 0; ) {
      ...
      ie ? he === 44 && B(S, "expected the node content, but found ','") : B(S, "missed comma between flow collection entries"), ce = oe = ye = null, $e = U = !1, he === 63 && (qe = S.input.charCodeAt(S.position + 1), b(qe) && ($e = U = !0, S.position++, R(S, !0, te))), pe = S.line, ae = S.lineStart, de = S.position, ge(S, te, r, !1, !0), ce = S.tag, oe = S.result, R(S, !0, te), he = S.input.charCodeAt(S.position), (U || S.line === pe) && he === 58 && ($e = !0, he = S.input.charCodeAt(++S.position), R(S, !0, te), ge(S, te, r, !1, !0), ye = S.result), ne ? j(S, me, se, ce, oe, ye, pe, ae, de) : $e ? me.push(j(S, null, se, ce, oe, ye, pe, ae, de)) : me.push(oe), R(S, !0, te), he = S.input.charCodeAt(S.position), he === 44 ? (ie = !0, he = S.input.charCodeAt(++S.position)) : ie = !1;
    }
...
`, de ? 1 + ve : ve), de = !0, le = !0, ve = 0, ie = S.position; !p($e) && $e !== 0; )
  ...
  function X(S, te, ie) {
    var pe, ae, de, le, me, ve, qe = S.tag, Fe = S.anchor, $e = {}, U = /* @__PURE__ */ Object.create(null), ne = null, se = null, oe = null, ce = !1, ye = !1, he;
    if (S.firstTabInLine !== -1) return !1;
    for (S.anchor !== null && (S.anchorMap[S.anchor] = $e), he = S.input.charCodeAt(S.position); he !== 0; ) {
      if (!ce && S.firstTabInLine !== -1 && (S.position = S.firstTabInLine, B(S, "tab characters must not be used in indentation")), pe = S.input.charCodeAt(S.position + 1), de = S.line, (he === 63 || he === 58) && b(pe))
        he === 63 ? (ce && (j(S, $e, U, ne, se, null, le, me, ve), ne = se = oe = null), ye = !0, ce = !0, ae = !0) : ce ? (ce = !1, ae = !0) : B(S, "incomplete explicit mapping pair; a key node is missed; or followed by a non-tabulated empty line"), S.position += 1, he = pe;
      else {
        ...
        if (S.line === de) {
          ...
          if (he === 58)
            he = S.input.charCodeAt(++S.position), b(he) || B(S, "a whitespace character is expected after the key-value separator within a block mapping"), ce && (j(S, $e, U, ne, se, null, le, me, ve), ne = se = oe = null), ye = !0, ce = !1, ae = !1, ne = S.tag, se = S.result;
          else if (ye)
      ...
      if ((S.line === de || S.lineIndent > te) && (ce && (le = S.line, me = S.lineStart, ve = S.position), ge(S, te, o, !0, ae) && (ce ? se = S.result : oe = S.result), ce || (j(S, $e, U, ne, se, oe, le, me, ve), ne = se = oe = null), R(S, !0, -1), he = S.input.charCodeAt(S.position)), (S.line === de || S.lineIndent > te) && he !== 0)
        B(S, "bad indentation of a mapping entry");
      else if (S.lineIndent < te)
        break;
    }
    return ce && j(S, $e, U, ne, se, null, le, me, ve), ye && (S.tag = qe, S.anchor = Fe, S.kind = "mapping", S.result = $e), ye;
  }
  function J(S) {
...
` + e.repeat(" ", U.indent * ne);
  ...
  function O(U, ne, se) {
    var oe = I(U), ce = oe && !N(U);
    return (
      // ns-plain-safe
      (se ? (
        // c = flow-in
        oe
      ) : oe && U !== y && U !== T && U !== P && U !== q && U !== K) && U !== f && !(ne === E && !ce) || I(ne) && !N(ne) && U === f || ne === E && ce
    );
  }
  function Q(U) {
    return x(U) && U !== r && !N(U) && U !== p && U !== _ && U !== E && U !== y && U !== T && U !== P && U !== q && U !== K && U !== f && U !== g && U !== h && U !== a && U !== M && U !== b && U !== $ && U !== v && U !== d && U !== m && U !== w && U !== G;
  }
  function H(U) {
    return !N(U) && U !== E;
  }
  ...
  function Ne(U, ne, se, oe, ce, ye, he, _e) {
    var we, be = 0, Be = null, We = !1, Me = !1, Lr = oe !== -1, Tt = -1, hr = Q(A(U, 0)) && H(A(U, U.length - 1));
    if (ne || he)
    ...
    return !We && !Me ? hr && !he && !ce(U) ? X : ye === V ? ge : J : se > 9 && L(U) ? ge : he ? ye === V ? ge : J : Me ? fe : re;
  }
  function De(U, ne, se, oe, ce) {
    U.dump = (function() {
      if (ne.length === 0)
        return U.quotingType === V ? '""' : "''";
      if (!U.noCompatMode && (F.indexOf(ne) !== -1 || Y.test(ne)))
        return U.quotingType === V ? '"' + ne + '"' : "'" + ne + "'";
      var ye = U.indent * Math.max(1, se), he = U.lineWidth === -1 ? -1 : Math.max(Math.min(U.lineWidth, 40), U.lineWidth - ye), _e = oe || U.flowLevel > -1 && se >= U.flowLevel;
      function we(be) {
        return R(U, be);
      }
      switch (Ne(
        ...
        case J:
          return "'" + ne.replace(/'/g, "''") + "'";
        case re:
          return "|" + Oe(ne, U.indent) + Se(j(ne, ye));
        case fe:
          return ">" + Oe(ne, U.indent) + Se(j(S(ne, he), ye));
        case ge:
          return '"' + ie(ne) + '"';
        default:
...
` : "") + te(we, ne), ce = ye;
  ...
  function te(U, ne) {
    if (U === "" || U[0] === " ") return U;
    for (var se = / [^ ]/g, oe, ce = 0, ye, he = 0, _e = 0, we = ""; oe = se.exec(U); )
      _e = oe.index, _e - ce > ne && (ye = he > ce ? he : _e, we += `
` + U.slice(ce, ye), ce = ye + 1), he = _e;
    return we += `
...
` + U.slice(he + 1) : we += U.slice(ce), we.slice(1);
  ...
  function pe(U, ne, se) {
    var oe = "", ce = U.tag, ye, he, _e;
    for (ye = 0, he = se.length; ye < he; ye += 1)
      _e = se[ye], U.replacer && (_e = U.replacer.call(se, String(ye), _e)), (ve(U, ne, _e, !1, !1) || typeof _e > "u" && ve(U, ne, null, !1, !1)) && (oe !== "" && (oe += "," + (U.condenseFlow ? "" : " ")), oe += U.dump);
    U.tag = ce, U.dump = "[" + oe + "]";
  }
  function ae(U, ne, se, oe) {
    var ce = "", ye = U.tag, he, _e, we;
  ...
  function de(U, ne, se) {
    var oe = "", ce = U.tag, ye = Object.keys(se), he, _e, we, be, Be;
    for (he = 0, _e = ye.length; he < _e; he += 1)
      Be = "", oe !== "" && (Be += ", "), U.condenseFlow && (Be += '"'), we = ye[he], be = se[we], U.replacer && (be = U.replacer.call(se, we, be)), ve(U, ne, we, !1, !1) && (U.dump.length > 1024 && (Be += "? "), Be += U.dump + (U.condenseFlow ? '"' : "") + ":" + (U.condenseFlow ? "" : " "), ve(U, ne, be, !1, !1) && (Be += U.dump, oe += Be));
    U.tag = ce, U.dump = "{" + oe + "}";
  }
  function le(U, ne, se, oe) {
    var ce = "", ye = U.tag, he = Object.keys(se), _e, we, be, Be, We, Me;
    if (U.sortKeys === !0)
      he.sort();
    ...
    for (_e = 0, we = he.length; _e < we; _e += 1)
      Me = "", (!oe || ce !== "") && (Me += D(U, ne)), be = he[_e], Be = se[be], U.replacer && (Be = U.replacer.call(se, be, Be)), ve(U, ne + 1, be, !0, !0, !0) && (We = U.tag !== null && U.tag !== "?" || U.dump && U.dump.length > 1024, We && (U.dump && u === U.dump.charCodeAt(0) ? Me += "?" : Me += "? "), Me += U.dump, We && (Me += D(U, ne)), ve(U, ne + 1, Be, !0, We) && (U.dump && u === U.dump.charCodeAt(0) ? Me += ":" : Me += ": ", Me += U.dump, ce += Me));
    U.tag = ye, U.dump = ce || "{}";
  }
  function me(U, ne, se) {
    var oe, ce, ye, he, _e, we;
    for (ce = se ? U.explicitTypes : U.implicitTypes, ye = 0, he = ce.length; ye < he; ye += 1)
  ...
  function ve(U, ne, se, oe, ce, ye, he) {
    ...
    if (Be && (We = U.duplicates.indexOf(se), Me = We !== -1), (U.tag !== null && U.tag !== "?" || Me || U.indent !== 2 && ne > 0) && (ce = !1), Me && U.usedDuplicates[We])
      U.dump = "*ref_" + We;
    else {
      if (Be && Me && !U.usedDuplicates[We] && (U.usedDuplicates[We] = !0), _e === "[object Object]")
  ...
  function qe(U, ne) {
    var se = [], oe = [], ce, ye;
    for (Fe(U, se, oe), ce = 0, ye = oe.length; ce < ye; ce += 1)
  ...
  function Fe(U, ne, se) {
    ...
    if (U !== null && typeof U == "object")
      if (ce = ne.indexOf(U), ce !== -1)
        ...
        for (ce = 0, ye = U.length; ce < ye; ce += 1)
          Fe(U[ce], ne, se);
      else
        for (oe = Object.keys(U), ce = 0, ye = oe.length; ce < ye; ce += 1)
          Fe(U[oe[ce]], ne, se);
  }
  function $e(U, ne) {
    ne = ne || {};
...
function e0() {
  if (eh) return wc;
  eh = 1;
  const e = Fn(), t = rs(), s = pt(), n = Yg(), l = Zr(), r = $_(), i = S_(), u = b_(), o = R_(), c = T_(), a = P_(), d = N_(), f = O_(), m = At(), g = I_(), v = A_(), h = el(), y = C_(), p = D_(), E = is(), b = tl(), $ = Jg(), _ = Qg(), w = rl(), T = nl(), P = Zg(), G = k_(), q = as(), M = Ct(), K = ss(), k = q_(), F = F_(), Y = U_(), B = j_(), W = M_(), Z = il(), V = x_(), C = V_(), j = G_(), D = B_(), R = H_();
  return wc = {
    parse: l,
    valid: r,
    clean: i,
...
function z_() {
  return th || (th = 1, (function(e, t) {
    ...
    ), U = A ? O.Buffer : void 0, ne = O.Symbol, se = O.Uint8Array, oe = de.propertyIsEnumerable, ce = pe.splice, ye = ne ? ne.toStringTag : void 0, he = Object.getOwnPropertySymbols, _e = U ? U.isBuffer : void 0, we = te(Object.keys, Object), be = qr(O, "DataView"), Be = qr(O, "Map"), We = qr(O, "Promise"), Me = qr(O, "Set"), Lr = qr(O, "WeakMap"), Tt = qr(Object, "create"), hr = yr(be), L0 = yr(Be), q0 = yr(We), F0 = yr(Me), U0 = yr(Lr), bl = ne ? ne.prototype : void 0, Ss = bl ? bl.valueOf : void 0;
    function pr(z) {
    ...
    pr.prototype.clear = j0, pr.prototype.delete = M0, pr.prototype.get = x0, pr.prototype.has = V0, pr.prototype.set = G0;
    function xt(z) {
      var ee = -1, ue = z == null ? 0 : z.length;
      for (this.clear(); ++ee < ue; ) {
        var Ee = z[ee];
    ...
    jn.prototype.add = jn.prototype.push = ev, jn.prototype.has = tv;
    function Qt(z) {
    ...
    function Pl(z, ee, ue, Ee, ze, Te) {
      ...
      if (Xe && Te.get(ee))
        return Xe == ee;
      var gt = -1, Pt = !0, nt = ue & r ? new jn() : void 0;
...
function K_() {
  if (rh) return Ur;
  rh = 1, Object.defineProperty(Ur, "__esModule", { value: !0 }), Ur.DownloadedUpdateHelper = void 0, Ur.createTempUpdateFile = u;
  const e = kn, t = jt, s = z_(), n = /* @__PURE__ */ fr(), l = Ge;
  let r = class {
    constructor(c) {
...
function n0() {
  ...
  const e = rt(), t = jt, s = Dn, n = al(), l = Buffer.from(`\r
\r
`);
  var r;
  (function(o) {
...
function i0() {
  ...
  const e = rt(), t = /* @__PURE__ */ fr(), s = jt, n = n0(), l = Yr, r = al(), i = rE(), u = nE();
  let o = class {
...
function Th() {
  ...
  const e = rt(), t = Qa, s = /* @__PURE__ */ fr(), n = jt, l = Ge, r = en(), i = s0(), u = Rt(), o = kr();
...
function kh() {
  ...
  const e = rt(), t = /* @__PURE__ */ fr(), s = jt, n = Ge, l = kv, r = sl(), i = Rt(), u = Qa, o = kn;
...
const lr = Ng.homedir(), ol = Ng.tmpdir(), { env: Xr } = Ke, lE = (e) => {
  ...
  const t = Xr.APPDATA || je.join(lr, "AppData", "Roaming"), s = Xr.LOCALAPPDATA || je.join(lr, "AppData", "Local");
  return {
    // Data/config/cache/log are invented by me as Windows isn't opinionated about this
    data: je.join(s, e, "Data"),
    config: je.join(t, e, "Config"),
    cache: je.join(s, e, "Cache"),
    log: je.join(s, e, "Log"),
    temp: je.join(ol, e)
  };
}, dE = (e) => {
...
function Xa() {
  ...
  const e = d0(), t = h0(), s = cs(), n = Pe(), l = Le();
  var r;
  (function(p) {
...
function ls() {
  ...
  const e = Le(), t = us(), s = CE(), n = /* @__PURE__ */ new Set([
    "type",
    "format",
    "pattern",
    "maxLength",
...
function fs() {
  ...
  const e = NE(), t = Xa(), s = h0(), n = Xa(), l = OE(), r = IE(), i = AE(), u = Pe(), o = Dt(), c = ls(), a = Le(), d = cs();
  function f(A) {
    if ($(A) && (w(A), b(A))) {
      h(A);
      return;
  ...
  function C(A, L) {
    ...
    for (const J in X) {
      ...
      if (typeof re == "object" && (0, s.shouldUseRule)(A.schema, re)) {
        ...
        fe.length && !fe.some((ge) => j(L, ge)) && N(A, `missing type "${fe.join(",")}" for keyword "${J}"`);
      }
    }
  }
  function j(A, L) {
...
function hs() {
  ...
  const e = Pe(), t = ul(), s = Dt(), n = ls(), l = Le(), r = fs();
  class i {
    constructor(y) {
      var p;
...
const DE = "https://raw.githubusercontent.com/ajv-validator/ajv/master/lib/refs/data.json#", kE = "Meta-schema for $data reference (JSON AnySchema extension proposal)", LE = "object", qE = ["$data"], FE = { $data: { type: "string", anyOf: [{ format: "relative-json-pointer" }, { format: "json-pointer" }] } }, UE = !1, jE = {
  $id: DE,
  description: kE,
  type: LE,
  required: qE,
...
function VE() {
  return mp || (mp = 1, (function(e) {
    ...
    const n = ul(), l = ds(), r = d0(), i = hs(), u = Pe(), o = ls(), c = Xa(), a = Le(), d = jE, f = xE(), m = (V, C) => new RegExp(V, C);
    m.code = "new RegExp";
    ...
    function E(V) {
      var C, j, D, R, N, x, I, O, Q, H, A, L, X, J, re, fe, ge, Ne, De, Oe, Se, S, te, ie, pe;
    ...
    class b {
      ...
      _addSchema(C, j, D, R = this.opts.validateSchema, N = this.opts.addUsedSchema) {
        ...
        return O = new i.SchemaEnv({ schema: C, schemaId: I, meta: j, baseId: D, localRefs: Q }), this._cache.set(O.schema, O), N && !D.startsWith("#") && (D && this._checkUnique(D), this.refs[D] = O), R && this.validateSchema(C, !0), O;
      }
      _checkUnique(C) {
    ...
    function F(V, C, j) {
      ...
      const { RULES: N } = this;
      let x = R ? N.post : N.rules.find(({ type: O }) => O === j);
...
function ll() {
  ...
  const e = ds(), t = kt(), s = Pe(), n = Dt(), l = hs(), r = Le(), i = {
    keyword: "$ref",
    schemaType: "string",
    code(c) {
...
function sw() {
  if (Up) return Ai;
  Up = 1, Object.defineProperty(Ai, "__esModule", { value: !0 });
  const e = Pe(), t = Le(), n = {
...
function v0() {
  if (jp) return Ci;
  jp = 1, Object.defineProperty(Ci, "__esModule", { value: !0 });
  const e = kt(), t = Pe(), s = Dt(), n = Le(), r = {
...
function dw() {
  if (Hp) return Ui;
  Hp = 1, Object.defineProperty(Ui, "__esModule", { value: !0 });
  const e = Le(), t = {
    keyword: "allOf",
    schemaType: "array",
    code(s) {
...
function hw() {
  if (zp) return ji;
  zp = 1, Object.defineProperty(ji, "__esModule", { value: !0 });
  const e = Pe(), t = Le(), n = {
    keyword: "if",
    schemaType: ["object", "boolean"],
    trackErrors: !0,
...
function Aw() {
  ...
  const e = Pe(), t = Iw(), s = hs(), n = ds(), l = Le(), i = {
...
function ms() {
  ...
  const e = Ue(), t = us(), s = tS(), n = /* @__PURE__ */ new Set([
    "type",
    "format",
    "pattern",
    "maxLength",
...
function ys() {
  ...
  const e = J$(), t = Ya(), s = $0(), n = Ya(), l = Q$(), r = Z$(), i = eS(), u = Ce(), o = dr(), c = ms(), a = Ue(), d = ps();
  function f(A) {
    if ($(A) && (w(A), b(A))) {
      h(A);
      return;
...
function pl() {
  ...
  const e = Ce(), t = hl(), s = dr(), n = ms(), l = Ue(), r = ys();
  class i {
    constructor(y) {
      var p;
      this.refs = {}, this.dynamicAnchors = {};
...
function lS() {
  return Um || (Um = 1, (function(e) {
    ...
    const n = hl(), l = gs(), r = w0(), i = pl(), u = Ce(), o = ms(), c = Ya(), a = Ue(), d = cS, f = uS(), m = (V, C) => new RegExp(V, C);
    m.code = "new RegExp";
    const g = ["removeAdditional", "useDefaults", "coerceTypes"], v = /* @__PURE__ */ new Set([
      "validate",
      "serialize",
...
function fS() {
  if (jm) return ua;
  jm = 1, Object.defineProperty(ua, "__esModule", { value: !0 });
  const e = {
    keyword: "id",
    code() {
      throw new Error('NOT SUPPORTED: keyword "id", use "$id" for schema ID');
...
function dS() {
  ...
  const e = gs(), t = Lt(), s = Ce(), n = dr(), l = pl(), r = Ue(), i = {
    keyword: "$ref",
    schemaType: "string",
    code(c) {
      const { gen: a, schema: d, it: f } = c, { baseId: m, schemaEnv: g, validateName: v, opts: h, self: y } = f, { root: p } = g;
...
function jS() {
  ...
  const e = S0(), t = TS(), s = b0(), n = PS(), l = NS(), r = OS(), i = IS(), u = R0(), o = AS(), c = CS(), a = DS(), d = kS(), f = LS(), m = qS(), g = FS(), v = US();
  function h(y = !1) {
    const p = [
      // any
      a.default,
...
function MS() {
  if (vy) return Ua;
  vy = 1, Object.defineProperty(Ua, "__esModule", { value: !0 });
  const e = Ce(), s = {
    keyword: "format",
    type: ["number", "string"],
    schemaType: "string",
...
function GS() {
  ...
  const e = hS(), t = RS(), s = jS(), n = xS(), l = VS(), r = [
    e.default,
    t.default,
    (0, s.default)(),
    n.default,
...
function HS() {
  if (Sy) return ja;
  Sy = 1, Object.defineProperty(ja, "__esModule", { value: !0 });
  const e = Ce(), t = BS(), s = pl(), n = gs(), l = Ue(), i = {
    keyword: "discriminator",
    type: "object",
    schemaType: "object",
    error: {
...
function mt() {
  if (Dy) return Jc;
  Dy = 1;
  const e = _s(), { MAX_LENGTH: t, MAX_SAFE_INTEGER: s } = vs(), { safeRe: n, t: l } = Un(), r = yl(), { compareIdentifiers: i } = T0();
  class u {
    constructor(c, a) {
      if (a = r(a), c instanceof u) {
        if (c.loose === !!a.loose && c.includePrerelease === !!a.includePrerelease)
...
function bb() {
  if (rg) return Eu;
  rg = 1;
  const e = mt(), t = tn(), { safeRe: s, t: n } = Un();
  return Eu = (r, i) => {
    if (r instanceof e)
      return r;
    if (typeof r == "number" && (r = String(r)), typeof r != "string")
...
function Ft() {
  ...
  const s = Rb(), n = new s(), l = yl(), r = ws(), i = _s(), u = mt(), {
    ...
    tildeTrimReplace: d,
    caretTrimReplace: f
  } = Un(), { FLAG_INCLUDE_PRERELEASE: m, FLAG_LOOSE: g } = vs(), v = (k) => k.value === "<0.0.0-0", h = (k) => k.value === "", y = (k, F) => {
    let Y = !0;
    const B = k.slice();
    let W = B.pop();
    for (; Y && B.length; )
...
function ws() {
  ...
  Su = t;
  const s = yl(), { safeRe: n, t: l } = Un(), r = O0(), i = _s(), u = mt(), o = Ft();
  return Su;
}
var bu, sg;
function $s() {
...
function qb() {
  if (vg) return qu;
  vg = 1;
  const e = Un(), t = vs(), s = mt(), n = T0(), l = tn(), r = db(), i = hb(), u = pb(), o = mb(), c = yb(), a = gb(), d = vb(), f = _b(), m = qt(), g = Eb(), v = wb(), h = gl(), y = $b(), p = Sb(), E = Es(), b = vl(), $ = P0(), _ = N0(), w = _l(), T = El(), P = O0(), G = bb(), q = ws(), M = Ft(), K = $s(), k = Tb(), F = Pb(), Y = Nb(), B = Ob(), W = Ib(), Z = wl(), V = Ab(), C = Cb(), j = Db(), D = kb(), R = Lb();
  return qu = {
    parse: l,
    valid: r,
    clean: i,
...
var Fb = qb();
const Kr = /* @__PURE__ */ Og(Fb), Ub = Object.prototype.toString, jb = "[object Uint8Array]", Mb = "[object ArrayBuffer]";
function I0(e, t, s) {
  return e ? e.constructor === t ? !0 : Ub.call(e) === s : !1;
}
function A0(e) {
  return I0(e, Uint8Array, jb);
}
function xb(e) {
...
const Uu = "aes-256-cbc", cr = () => /* @__PURE__ */ Object.create(null), Eg = (e) => e !== void 0, ju = (e, t) => {
...
class Kb {
  ...
  clear() {
    ...
    for (const s of Object.keys(this.#t))
      Eg(this.#t[s]) && (ju(s, this.#t[s]), this.#e.accessPropertiesByDotNotation ? ii(t, s, this.#t[s]) : t[s] = this.#t[s]);
    this.store = t;
  }
  onDidChange(t, s) {
    if (typeof t != "string")
  ...
  */
  ...
  _decryptData(t) {
    ...
    try {
      const s = t.slice(0, 16), n = vr.pbkdf2Sync(this.#r, s, 1e4, 32, "sha512"), l = vr.createDecipheriv(Uu, n, s), r = t.slice(17), i = typeof r == "string" ? Va(r) : r;
      return xa(Fu([l.update(i), l.final()]));
    } catch {
      try {
        const s = t.slice(0, 16), n = vr.pbkdf2Sync(this.#r, s.toString(), 1e4, 32, "sha512"), l = vr.createDecipheriv(Uu, n, s), r = t.slice(17), i = typeof r == "string" ? Va(r) : r;
        return xa(Fu([l.update(i), l.final()]));
      } catch {
      }
    }
  ...
  _ensureDirectory() {
    Re.mkdirSync(je.dirname(this.path), { recursive: !0 });
  }
  _write(t) {
  ...
  _watch() {
    if (this._ensureDirectory(), Re.existsSync(this.path) || this._write(cr()), Ke.platform === "win32" || Ke.platform === "darwin") {
      ...
      const t = je.dirname(this.path), s = je.basename(this.path);
...
class Wb extends Kb {
  constructor(t) {
    ...
    t = {
      name: "config",
      ...t
    }, t.projectVersion ||= n, t.cwd ? t.cwd = je.isAbsolute(t.cwd) ? t.cwd : je.join(s, t.cwd) : t.cwd = s, t.configName = t.name, delete t.name, super(t);
  }
  static initRenderer() {
    $g();
  }
...
let Gu, ke = null, za;
async function Yb() {
  Gu || (Gu = (await import("better-sqlite3")).default, za = Ge.join(Ut.getPath("userData"), "gravio.db"));
}
async function Jb() {
  try {
    await Yb();
    const e = Ge.dirname(za);
    return jt.existsSync(e) || jt.mkdirSync(e, { recursive: !0 }), ke = new Gu(za, { verbose: console.log }), ke.pragma("journal_mode = WAL"), Qb(), console.log("✅ Base de datos SQLite inicializada en:", za), ke;
  } catch (e) {
    throw console.error("❌ Error al inicializar base de datos:", e), e;
  }
}
function Qb() {
  ke && (ke.pragma("foreign_keys = OFF"), ke.exec(`
  ...
  `), ke.pragma("foreign_keys = OFF"), console.log("✅ Tablas de base de datos creadas (estructura compatible con Supabase)"), console.log("⚠️  Foreign keys deshabilitadas para operación offline-first"));
}
function C0(e) {
...
function tR(e) {
  if (!ke)
    throw new Error("Base de datos no inicializada");
  const t = ke.transaction((s) => {
    for (const n of s) {
      const l = ke.prepare(n.sql), r = C0(n.params || []);
      l.run(...r);
    }
  });
  try {
...
function rR(e, t = []) {
  if (!ke) throw new Error("Database not initialized");
  try {
    return ke.prepare(e).get(...t);
  } catch (s) {
...
function iR(e, t = []) {
  if (!ke) throw new Error("Database not initialized");
  try {
    return ke.prepare(e).run(...t);
  } catch (s) {
    throw console.error("❌ Error en runCommand:", s), s;
  }
}
function aR() {
  ke && (ke.close(), ke = null, console.log("✅ Base de datos cerrada"));
}
const sR = Iv(Av);
let Ja, D0;
async function k0() {
...
Ut.on("before-quit", async () => {
  await Sl(), aR();
});
function mR() {
  He.handle("app:getVersion", () => Ut.getVersion()), He.handle("app:getPlatform", () => process.platform), He.handle("serial:list", oR), He.handle("serial:open", async (e, t, s) => await uR(t, s, (l) => {
...
const yR = Ut.requestSingleInstanceLock();
yR ? Ut.on("second-instance", () => {
